    ...
    return <>
        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <hr/>
            <ul className="fa-ul">
              <li className={price.isUser ? "" : "text-muted"}><span className="fa-li"><i className={price.isUser ? "fas fa-check" : "fas fa-times"}></i></span>{price.plan == "FREE" ? <>{price.user}</> :<>{price.user}</>}</li>
